...
def test_step():
    ...
    action = (1.0,0)  # Sample a valid action (e.g., maximum throttle and no pitch change)
...
def test_environments_compatible():
    ...
    # JAX step
    jax_obs, jax_next_state, jax_reward, jax_terminated, jax_truncated, _ = jax_env.step(key, jax_state, action, jax_env.default_params)
