...
| `restart_steps` | 240 (1 h) | steps the plant is down after a trip before it restarts (cool, purge and re-feed after a runaway; provisional); where a plant engineer would get it: the plant's restart procedure |
