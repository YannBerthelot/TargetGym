...
| `restart_steps` | 100 (5 s) | steps the plant is down after a trip before it restarts (a generic loop's reset; provisional); where a plant engineer would get it: the plant's restart procedure |
