...
| `restart_steps` | 600 (10 min) | steps the plant is down after a trip before it restarts (refill after an overflow or dry-out; provisional); where a plant engineer would get it: the plant's restart procedure |
