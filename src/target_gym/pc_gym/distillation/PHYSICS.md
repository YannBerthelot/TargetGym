...
| `failure_cost` | 3.61e6 | twice the reachable two-product excursion's cost, 2 x 2 x (0.095 / 1e-4)^2: a 0.98 top target to the 0.90 trip, a 0.02 bottom target to the 0.10 trip, per trip step |
